...
# ★ Cloudinary　　　これを元に改良してフルで返して　勝手にカットするなよ
import cloudinary
...
def register(request: Request, username: str = Form(...), password: str = Form(...)):
    ...
    try:
        ...
        # UniqueViolation含め、登録失敗はregisterへ戻す（環境差で落とさない）
        return RedirectResponse("/register", status_code=303)
